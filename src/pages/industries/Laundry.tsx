...
import { WashingMachine, Truck, CreditCard, Users, ArrowRight } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: "Complete order tracking from pickup to delivery with status updates"
    },
    {
      icon: <Truck className="w-8 h-8" />,
      title: "Pickup & Delivery",
      description: "Automated pickup and delivery scheduling with route optimization"
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: "Billing System",
      description: "Integrated pricing, billing, and payment processing system"
    }
  ]
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Streamline your laundry and dry-cleaning operations with our comprehensive management system. 
              From order tracking to delivery management, handle everything efficiently.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className='container mx-auto px-6'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className='text-3xl font-bold text-gray-800 mb-6'>Why Choose Our Laundry Solution?</h2>
