  ...
  const features = [
    {
      ...
      description: "Complete member registration, tracking, and renewal management system"
    },
    {
      icon: <Calendar className="w-8 h-8" />,
      title: "Class Scheduling",
      description: "Automated fitness class booking and instructor management"
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: "Payment Processing",
      description: "Integrated billing, payment tracking, and membership fee collection"
    }
  ]
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Streamline your fitness center operations with our comprehensive gym management system. 
              Manage memberships, classes, and payments with ease.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className='container mx-auto px-6'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className='text-3xl font-bold text-gray-800 mb-6'>Why Choose Our Gym Solution?</h2>
            ...
            >
              ...
              <p className='text-gray-600 mb-6'>
                Transform your gym operations with our comprehensive management solution.
